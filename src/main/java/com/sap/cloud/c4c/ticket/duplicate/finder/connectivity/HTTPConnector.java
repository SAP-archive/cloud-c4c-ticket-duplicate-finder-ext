...
public class HTTPConnector {
    ...
    private static final String OAUTH_AUTHENTICATION_PROPERTY = "OAuth2SAMLBearerAssertion";
    ...
    private SimpleHttpResponse executeMethodGET(HttpURLConnection urlConnection) throws IOException,
                                                                                 InvalidResponseException {
        SimpleHttpResponse httpResponse = new SimpleHttpResponse(urlConnection.getURL().toString(),
    ...
    private void logResponse(SimpleHttpResponse httpResponse) {
        ...
        LOGGER.debug(DEBUG_RESPONSE_MSG, requestPath, httpResponse.getResponseCode(),
    ...
    private List<AuthenticationHeader> getAuthenticationHeaders(DestinationConfiguration destinationConfiguration)
        ...
        if (OAUTH_AUTHENTICATION_PROPERTY.equals(authenticationType)) {
        ...
        try {
            if (this.localConnectivityConfiguration == null) {
                ...
                this.localConnectivityConfiguration = (ConnectivityConfiguration) ctx
                        .lookup(CONNECTIVITY_CONFIGURATION_LOOKUP_NAME);
            }

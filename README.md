...
| ---------------- | ---------- |
| 1. In the *Eclipse IDE*, click on the *Open Perspective* 
  button in the top right corner and choose Git. | ![Open Git Perspective](./src/main/resources/images/OpenGitPesrpective.png) |
